...
public class CaseTest {
    ...
    /**
     * Test of nombreLibert̩sAutourDe method, of class Case.
     */
    @Test
    public void testNombreLibertesAutourDe() {
        Goban g=new Goban(9);
        ...
        assertEquals(2,g.getCase(8,8).nombreLibertesAutourDe());
        assertEquals(0,g.getCase(2, 2).nombreLibertesAutourDe());
        assertEquals(4,g.getCase(5,5).nombreLibertesAutourDe());
    }
